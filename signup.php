...
<head>
  ...
  <title>Sign Up Success - DocNowLk</title>
  <style>
    * {
      margin: 0;
      padding: 0;
...
<body>
  ...
  <div class="content">
    ...
    $sql = "INSERT INTO Patient(fname, lname, Email, telephone, username, password, Birthday, City)
            VALUES('$FNAME', '$LNAME', '$EMAIL', '$TEL', '$UNAME', '$PASS', '$DOB', '$CITY')";
    ...
    <a href="signup.html" class="btn">Back to Sign Up</a>
  </div>
</body>
</html>
